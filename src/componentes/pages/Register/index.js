...
import { useNavigate } from "react-router-dom"; // Importe useNavigate para redirecionamento (opcional)
import styled from 'styled-components';
import ImagemInicial from '../../../img/cadastro.png';
...
const Corpo = styled.div`
    ...
    padding: 10px;
    width: 100%; // Garante que o corpo ocupe toda a altura da viewport
    display: flex; // Necessário para centralizar o conteúdo com o wrapper abaixo
`;

export default function Register({titulo}) {
        ...
        if(senha === confSenha){
            ...
            try {
                const response = await fetch('http://localhost:3000/usuarios/registrar', {
                    ...
                    body: JSON.stringify({ nome, email, saldo, senha }), // Envia os dados como JSON
                });
                        ...
                        <div className="col-12 col-md-6">
                            <LoginFormContainer>
                                ...
                                <form onSubmit={execSubmit}>
                                    <div className="mb-3">
                                        <label htmlFor="nome" className="form-label" style={{ color: 'white' }}>Nome</label>
                                        <input
                                            type="text" 
                                            className="form-control"
                                            id="nome"
                                            placeholder="Insira seu nome"
                                            value={nome} // Controla o valor do input
                                    ...
                                    <div className="mb-3">
                                        <label htmlFor="saldo" className="form-label" style={{ color: 'white' }}>Saldo</label>
                                        <input
                                            type="text" 
                                            className="form-control"
                                            id="saldo"
                                            placeholder="Insira o saldo inicial"
                                            value={saldo} // Controla o valor do input
                                            onChange={(e) => setSaldo(e.target.value)} // Atualiza o estado ao digitar
                                            required // Campo obrigatório
                                        />
                                    </div>
                                    ...
                                    <div className="mb-3">
                                        <label htmlFor="confSenha" className="form-label" style={{ color: 'white' }}>Confirme a Senha</label>
                                        <input
                                            type="password"
                                            className="form-control"
                                            id="confSenha"
                                            placeholder="Confirme sua senha"
                                            value={confSenha} // Controla o valor do input
                                            onChange={(e) => setConfSenha(e.target.value)} // Atualiza o estado ao digitar
                                            required // Campo obrigatório
                                        />
                                    </div>
